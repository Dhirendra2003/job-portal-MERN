...
function Job({ data }) {
  ...
  return (
    <div className='p-5 pb-2 rounded-lg shadow-lg bg-white border-2 border-gray-100 dark:border-gray-700 dark:bg-neutral-900 dark:border-gray-600 xs:max-w-96 m-auto h-[100%] grid'>
